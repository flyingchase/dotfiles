...
local plug_map = {
    ...
    ["n|<A-4>"] = map_cr("BufferLineGoToBuffer 5"):with_noremap():with_silent(),
    ...
    ["n|<leader>lr"] = map_cr("LspRestart"):with_noremap():with_silent()
        :with_nowait(),
    ["n|<leader>en"] = map_cr('Lspsaga diagnostic_jump_next'):with_noremap()
        :with_silent(),
    ["n|<leader>ep"] = map_cr('Lspsaga diagnostic_jump_prev'):with_noremap()
        :with_silent(),
    ["n|<C-k>"] = map_cr("Lspsaga hover_doc"):with_noremap():with_silent(),
    ...
    ["n|<Leader>tt"] = map_cr('NvimTreeFindFile'):with_noremap():with_silent(),
    ["n|<Leader>tf"] = map_cr('NvimTreeRefresh'):with_noremap():with_silent(),
    -- Plugin Telescope
