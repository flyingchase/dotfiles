...
local on_attach = function(client, bufnr)
    ...
    buf_set_keymap('n', '<leader>e',
                   ...
                   opts)
    buf_set_keymap('n', '<leader>ep', '<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>',
                   opts)
    buf_set_keymap('n', '<leader>en', '<cmd>lua vim.lsp.diagnostic.goto_next()<CR>',
                   opts)
    ...
    if client.resolved_capabilities.document_formatting then
        buf_set_keymap("n", "<leader>m", "<cmd>lua vim.lsp.buf.formatting()<CR>",
                       opts)
